  ...
  return (
    <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
      ...
      <View style={styles.card}>
        <Row styles={styles} label="Tier" value={result.ticket?.tier || '—'} />
        <Row styles={styles} label="Entry time" value={fmtTime(result.ts)} mono />
        <Row styles={styles} label="Zones unlocked" value={zones} valueColor={colors.lime} last />
      </View>
...
function Row({ styles, label, value, mono, valueColor, last }) {
  return (
...
function createStyles(colors) {
  return StyleSheet.create({
    ...
    row: { flexDirection: 'row', justifyContent: 'space-between', padding: 15, borderBottomWidth: 1, borderBottomColor: colors.borderSoft },
    ...
    footer: { textAlign: 'center', fontFamily: FONT.mono, fontSize: 12, color: colors.textDim, marginBottom: 16 },
